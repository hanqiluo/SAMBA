...
bio_analysis <- function(bio_template,
                         no_biodata,
                         save_directory,
                         reference_directory,
                         results_name) {
    ...
    # load the template
    if (file.exists(bio_template)) {
        temp_template <-  read.csv(file = bio_template, header = TRUE)
    ...
    if (file.exists(reference_directory)) {
        reference <-  read.csv(file = reference_directory, header = TRUE)
    } else {
